    ...
    return (
        <Container maxW='xl' centerContent>
            <Box display='flex' p={3} w='100%' m='20px 0px 15px 0px' justifyContent='center'>
                <Image src='inbox-logo.png' alt='Inbox-logo' textAlign='center' height='100px' />
                {/* <Text textAlign='center' color='#1C1B2C' fontSize='5xl' fontWeight='bold' fontFamily='Montserrat Subrayada'>InBox</Text> */}
            </Box>

            <Box bg='#e1e7eb' w='100%' p={4} borderRadius='lg' borderWidth='1px' borderColor='#1C1B2C' opacity={0.87} color='black' >
